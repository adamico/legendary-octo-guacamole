...
- **Extracted Room Manager**: Moved room-related logic (clipping, dimensions, background drawing) from `play.lua` into a dedicated `RoomManager` module (`src/room_manager.lua`), separating room responsibility from the scene logic.
